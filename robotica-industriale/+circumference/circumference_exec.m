function circumference_exec()
    ...
    [P1P2_arch, P1P2_derived_arch, Q1Q2_arch, Q1Q2_derived_arch] = Percorso.Arco(theta1,theta2);
    
    %% P2->P3 arch
    theta3=theta2; theta4=theta3+(pi/2)+angle;
    [P2P3_arch, P2P3_derived_arch, Q2Q3_arch, Q2Q3_derived_arch] = Percorso.Arco(theta3, theta4);
    
    %% P3->P1 arch
    theta5=theta4; theta6=theta5+(pi/2)+angle;
    [P3P1_arch, P3P1_derived_arch, Q3Q1_arch, Q3Q1_derived_arch] = Percorso.Arco(theta5, theta6);
