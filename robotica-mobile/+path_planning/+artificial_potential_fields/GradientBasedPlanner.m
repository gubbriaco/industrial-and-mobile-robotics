...
for i=1:max_its
    ...
    % La derivata direzionale della funzione f lungo la direzione del
    % versore v nel punto (x0, y0) e' data dal prodotto scalare tra il
    % gradiente della funzione valutato in (x0,y0) ed il versore v:
    % Dd( fv(x0,y0) ) = nabla( f(x0,y0) ) * v
    % Dd: derivata direzionale
